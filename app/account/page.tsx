...
export default function AccountPage() {
  ...
  return <main id="main-content" className="route account-route"><SiteHeader active="account" /><section className="account-stage">
